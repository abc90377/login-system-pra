...
<li class="list-group-item">姓名: <input type="text" name="acc"></li>  
<li class="list-group-item">生日: <input type="text" name="acc"></li>  
<li class="list-group-item">地址: <input type="text" name="acc"></li> 
